...
public class Main extends Collection {
    ...
    public static void main(String[] args) {
        ...
        Task testing = new Task("bee", "horible", 3);
        Task testing2 = new Task("boo", "good", 2);
        Task testing3 = new Task("ant", "IDK", 3);
        Task testing4 = new Task("bunny", "cute", 5);
        collection.addingTask(testing);
        collection.addingTask(testing2);
        collection.addingTask(testing3);
        collection.addingTask(testing4);
